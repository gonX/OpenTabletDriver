...
namespace OpenTabletDriver.Desktop.Interop.Input.Absolute
{
    ...
    public class WindowsAbsolutePointer : WindowsVirtualMouse, IAbsolutePointer
    {
        static WindowsAbsolutePointer()
        {
            timer = new System.Threading.Timer(
                state => ScreenToVirtualDesktop = new Vector2(
                    DesktopInterop.VirtualScreen.Width - 1,
                    DesktopInterop.VirtualScreen.Height - 1
                ) / 65535,
                null,
                TimeSpan.Zero,
        ...
        private static Vector2 ScreenToVirtualDesktop = new Vector2(DesktopInterop.VirtualScreen.Width - 1, DesktopInterop.VirtualScreen.Height - 1) / 65535;
