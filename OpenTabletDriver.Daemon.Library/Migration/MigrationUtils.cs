...
namespace OpenTabletDriver.Daemon.Library.Migration
{
    internal static class MigrationUtils
    {
        ...
        private static readonly Dictionary<Regex, string> NamespaceMigrationDict = new Dictionary<Regex, string>
        {
            ...
            { new Regex(@"OpenTabletDriver\.Binding\.(.+?)$"), @"OpenTabletDriver.Daemon.Library.Binding.{0}" },
            { new Regex(@"OpenTabletDriver\.Output\.(.+?)$"), @"OpenTabletDriver.Daemon.Library.Output.{0}" },
